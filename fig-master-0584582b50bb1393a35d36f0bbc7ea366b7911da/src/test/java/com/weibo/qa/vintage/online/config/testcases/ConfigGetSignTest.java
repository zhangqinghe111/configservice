 ...
 */
public class ConfigGetSignTest extends BaseTest {
	...
	public void testTwoGroup() {
		...
		String keyTemp1 = keyString + "1";
		String keyTemp2 = keyString + "2";

		String valueTemp1 = valueString + "1";
		String valueTemp2 = valueString + "2";
...
//		String sign2 = VintageConfigWebUtils.getsign(groupTemp2);
	...
	private void getsignParamNull(String groupStr) {
		try {
			VintageConfigWebUtils.getsign(groupStr);
